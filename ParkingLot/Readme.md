...
1.The ParkingLott class follows the Singleton pattern to ensure only one instance of the parking lot exists. 
...
3.The ParkingSpott class represents an individual parking spot and tracks the availability and the parked vehicle.
...
Singleton Pattern: Ensures only one instance of the ParkingLott class.
